/* copied from https://github.com/dataarts/webgl-globe */
import * as THREE from 'three';

export const globeMixin = {
  methods: {
    initGlobe(imageLoad) {
      const DAT = DAT || {};
      ...
      DAT.Globe = function(container, opts) {
        ...
        function init() {
          ...
          //   map         : new THREE.Texture('../../static/earthcloudmap.jpg'),
          ...
          //
          // var bumpMap =  THREE.ImageUtils.loadTexture("../../static/earthbump.jpg", {}, function(){});
          // var bumbUniforms = THREE.UniformsUtils.clone(shader.uniforms);
          // bumbUniforms['texture'].value = bumpMap;
          //
          // var bumbMaterial = new THREE.ShaderMaterial({
          //   uniforms: bumbUniforms
          // });
  ...
  mounted() {
    ...
    let earthmap = THREE.ImageUtils.loadTexture('../../static/world7.jpg');
    // let earthmap = THREE.ImageUtils.loadTexture('../../static/earthmap.jpg');
